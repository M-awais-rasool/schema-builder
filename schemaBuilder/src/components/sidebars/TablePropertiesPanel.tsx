      ...
      {!selectedNode && (
        <div className="flex-1 flex items-center justify-center p-4 bg-white">
          <div className="text-center">
            ...
            <h3 className="font-semibold text-black mb-2">No Table Selected</h3>
            <p className="text-gray-600 text-sm">Click on a table in the canvas to edit its properties and manage its fields.</p>
          </div>
        </div>
      )}
    </div>
