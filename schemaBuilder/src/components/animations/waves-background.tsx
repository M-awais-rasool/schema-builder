...
class Noise {
  ...
  constructor(seed = 0) {
    ...
    this.gradP = new Array(512).fill(this.grad3[0])
    this.seed(seed)
  }
  ...
  useEffect(() => {
    ...
    function setSize() {
      ...
      boundingRef.current = {
        ...
        left: Math.round(b.left + window.scrollX),
    ...
    function drawLines() {
      ...
      ctxLocal.beginPath()
      ctxLocal.strokeStyle = lineColor
      linesRef.current.forEach((points) => {
        ...
        points.forEach((p, idx) => {
          ...
          ctxLocal.lineTo(p1.x, p1.y)
          if (isLast) ctxLocal.moveTo(p2.x, p2.y)
        })
      })
      ctxLocal.stroke()
    }
    ...
    function onTouchMove(e: TouchEvent) {
      ...
      updateMouse(touch.clientX + window.scrollX, touch.clientY + window.scrollY)
    }
